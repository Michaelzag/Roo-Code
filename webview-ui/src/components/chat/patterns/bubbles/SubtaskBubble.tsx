...
/**
 * SubtaskContent - Uses shared simple content
 */
...
/**
 * SubtaskBubble - Uses shared bubble factory with subtask semantic
 */
export const SubtaskBubble = createBubbleComponent<{
	expanded?: boolean
	onToggleExpand?: () => void
}>(
	"subtask",
