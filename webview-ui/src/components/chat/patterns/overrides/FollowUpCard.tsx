...
export const FollowUpCard: React.FC<FollowUpCardProps> = ({ message, onSuggestionClick }) => {
	...
	const header = (
		<div
			className={`flex items-center ${DESIGN_SYSTEM.spacing.overrideHeaderPadding} bg-blue-50 dark:bg-blue-950/30 border-b border-blue-200 dark:border-blue-800/50`}>
	...
	return (
		<OverrideBubble
			...
			{/* Question Content */}
			<div className={DESIGN_SYSTEM.spacing.componentContentPadding}>
				<div
					className={`text-vscode-foreground text-[14px] leading-relaxed ${DESIGN_SYSTEM.spacing.componentBadgeMargin}`}>
					...
					<div className={DESIGN_SYSTEM.spacing.componentSectionGap}>
						{suggestions.map((suggestion: string, index: number) => (
							<button
								...
								className={`w-full text-left ${DESIGN_SYSTEM.spacing.componentCodePadding} rounded-lg border border-blue-200 dark:border-blue-700
								...
								<div className="flex items-start">
									<span
										className={`codicon codicon-circle-small ${DESIGN_SYSTEM.spacing.componentElementGap} mt-0.5 text-blue-500 dark:text-blue-400 opacity-70`}
									/>
