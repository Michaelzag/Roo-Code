...
const ChatViewComponent: React.ForwardRefRenderFunction<ChatViewRef, ChatViewProps> = (
	...
	const playSound = useCallback(
		...
		[playNotification, playCelebration, playProgressLoop],
	)
	...
	// Extract dependency variables to satisfy linter
	const lastMessageKey = JSON.stringify(lastMessage)
	const secondLastMessageKey = JSON.stringify(secondLastMessage)
	...
	}, [lastMessageKey, secondLastMessageKey, secondLastMessageAsk, playSound, t, lastMessage, isAutoApproved])
			...
			return (
				<ChatRow
					...
					isExpanded={
						...
						(messageOrGroup.ask === "command" || messageOrGroup.ask === "command_output" ? true : false)
					}
