...
import { t } from "../../../i18n"
import { createQdrantClientFromUrl, parseQdrantUrl } from "../../qdrant/common"
...
export class QdrantVectorStore implements IVectorStore {
	...
	constructor(workspacePath: string, url: string, vectorSize: number, apiKey?: string) {
		...
		this.client = createQdrantClientFromUrl(parsedUrl, apiKey)
	 ...
	 */
	// URL parsing helpers moved to shared qdrant/common
